...
contract Dex223ICOv2 {

    address public owner = msg.sender;

    uint256 public price_rate_USD = 1538; // Target price $0.00065 per D223 token.
    uint256 public price_rate_ETH = 1538 * 2242; // ETH price at the moment of deployment
    ...
    address public ICO_token      = 0xcCe968120e6Ded56F32fbfe5A2Ec06CBF1e7c8ED;
    ...
    function getRewardAmount(address _payment_token, uint256 _deposit) public view returns (uint256)
    {
        ...
        {
            return _deposit * price_rate_ETH;
        }
        return 0;
    }

    function set(uint256 _price_USD, uint256 _price_ETH, address _ICO_token, address _USDT, address _USDC, address _DAI) public
    {
        require(msg.sender == owner);
        price_rate_ETH     = _price_ETH;
